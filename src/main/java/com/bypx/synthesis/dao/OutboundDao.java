...
public class OutboundDao {
    ...
    public List query(InputParam param) {
        ...
        String sql="SELECT id_,type_id_,number_,price_,creater_,creater_id_,status_,cause_,DATE_FORMAT(create_date_,'%Y-%m-%d') AS create_date_  FROM jxc_product_order WHERE order_type_=2 ";
        sql+=formatSql(param);
